...
struct fs_output_stream* fs_create_output_with_data( fs_byte*, size_t len);
...
void fs_stream_write_byte( struct fs_output_stream*,  fs_byte);
...
void fs_stream_write_data( struct fs_output_stream*,  fs_byte*, size_t len );
...
struct fs_input_stream* fs_create_input_stream(const fs_byte* data, size_t len);
struct fs_input_stream* fs_create_input_stream_with_copy(const fs_byte* data, size_t len);

void fs_input_stream_set_data( struct fs_input_stream*, const fs_byte* data, size_t len);
void fs_input_stream_set_data_copy( struct fs_input_stream*, const fs_byte* data, size_t len);
...
void fs_input_stream_set_order( struct fs_input_stream*,  fs_byte order);
void fs_stream_free_input( struct fs_input_stream* );
fs_byte fs_stream_read_byte( struct fs_input_stream* );
...
const fs_byte* fs_input_stream_get_data_ptr( struct fs_input_stream* );
const fs_byte* fs_output_stream_get_dataptr( struct fs_output_stream* );
